...
<div class="row container" id="wrapper">
    <div class="halim-panel-filter">
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-6">
                    <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Phim hay</a> » <span><a href="danhmuc.php"></a> » <span class="breadcrumb_last" aria-current="page">Tôi Và Chúng Ta Ở Bên Nhau</span></span></span></span></div>
                </div>
            </div>
        </div>
            ...
            <div class="clearfix wrap-content">
                ...
                <div class="title-block">
                    ...
                    <div class="title-wrapper-xem full">
                        <h1 class="entry-title"><a href="" title="Tôi Và Chúng Ta Ở Bên Nhau" class="tl">Cửu Vĩ Hồ tập 1</a></h1>
                    </div>
                </div>
...
{{--                                    <a href="{{route('episode')}}"><li class="halim-episode"><span class="halim-btn halim-btn-2 active halim-info-1-1 box-shadow" data-post-id="37976" data-server="1" data-episode="1" data-position="first" data-embed="0" data-title="">1</span></li></a>--}}
{{--                                    <a href="{{route('episode')}}"><li class="halim-episode"><span class="halim-btn halim-btn-2 halim-info-1-2 box-shadow" data-post-id="37976" data-server="1" data-episode="2" data-position="" data-embed="0" data-title="" data-h1="">2</span></li></a>--}}
{{--                                    <a href="{{route('episode')}}"><li class="halim-episode"><span class="halim-btn halim-btn-2 halim-info-1-3 box-shadow" data-post-id="37976" data-server="1" data-episode="3" data-position="" data-embed="0" data-title="=">3</span></li></a>--}}
{{--                                    <a href="{{route('episode')}}"><li class="halim-episode"><span class="halim-btn halim-btn-2 halim-info-1-4 box-shadow" data-post-id="37976" data-server="1" data-episode="4" data-position="" data-embed="0" data-title="" data-h1="">4</span></li></a>--}}
{{--                                </ul>--}}
                                <div class="clearfix"></div>
                            </div>
                        </div>
                ...
                <div id="halim_related_movies-2" class="owl-carousel owl-theme related-film">
                    <article class="thumb grid-item post-38494">
                        <div class="halim-item">
                            <a class="halim-thumb" href="" title="">
                                ...
                                <div class="halim-post-title-box">
                                    <div class="halim-post-title ">
                                        <p class="entry-title"></p><p class="original_title"></p>
                                    </div>
                                </div>
                            </a>
                        </div>
